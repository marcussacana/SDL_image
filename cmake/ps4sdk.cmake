...
if (NOT "" STREQUAL "$ENV{OO_PS4_TOOLCHAIN}")
	include_directories("$ENV{OO_PS4_TOOLCHAIN}/include" )
...
#
	set(triple "x86_64-pc-freebsd12-elf")
...
#	)
	...
	set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -s -Wl -L${TAUON_SDK}/lib")
#
endif()
### IF NOT SCE SDK
#
...
if(PS4)
  set(binSuffix ".elf")
    link_libraries(SceSystemService_stub_weak SceUserService_stub_weak ScePosix_stub_weak 
					ScePad_stub_weak SceAudioOut_stub_weak SceSysmodule_stub_weak libScePad
                    libc_stub_weak.a
